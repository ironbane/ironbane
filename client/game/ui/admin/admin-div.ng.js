            ...
            return {
                ...
                controller: function($scope, $clientSettings, CharBuilder) {
                    ...
                    $scope.charImages = {
                        ...
                        'hair': [1,1000,1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014,1015,1016,1017,1018,1019,2,6],
                        'eyes': [1000,1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1011,1012,1013,1014,1015,1016,1017,1018,1019],
                        'skin': [1,10,1000,1001,1002,1003,1004,1010,1011,1012,1013,1014,1020,1021,1022,1023,1024,1025,1026,1027,1028,1029,1030,1031,1032,1033,1034,1035,11,1100,2,23,24,25,26,27,28,29,3,30,32,33,34,35,36,37,40,41,42,43,44,45,46,47,650,651,652,653,655,656,657,658,659,660,661,662,664,665,666,667,668,669,670,671,672,673,674,675,676,677,678,695,700,701,772,773]
                    };
                    ...
                    $scope.randomize = function () {
                        $scope.charPreview = {
                            body: _.random(0, $scope.charImages['body'].length - 1),
                            feet: _.random(0, $scope.charImages['feet'].length - 1),
                            head: _.random(0, $scope.charImages['head'].length - 1),
