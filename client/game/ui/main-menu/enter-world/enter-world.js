    ...
    .config(['$stateProvider', function($stateProvider) {
        ...
        $stateProvider.state('main-menu.enter-world', {
            ...
            controller: [
                ...
                'ChatService',
                function($scope, $state, GameService, $meteor, CharBuilder, $meteorUtils, dialogService, FantasyNameGenerator, ChatService) {
                    ...
                    var enterGame = function(charId) {
                        ...
                        ChatService.announce(activeChar.name + ' has joined the world.');
                    };
