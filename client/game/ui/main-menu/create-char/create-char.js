angular
	...
	.config(['$stateProvider', function ($stateProvider) {
		...
		$stateProvider.state('main-menu.create-char', {
			...
			controller: ['$scope', '$state', 'GameService', 'CharBuilder', 'Util', '_', 'IbConstants', '$meteor', 'dialogService',
			function ($scope, $state, GameService, CharBuilder, Util, _, IbConstants, $meteor, dialogService) {
