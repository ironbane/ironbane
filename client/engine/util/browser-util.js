    ...
    .service('BrowserUtil', [
        ...
        function($window) {
            ...
            if (this.browser.isMSIE) {
                var match = $window.navigator.userAgent.toLowerCase().match(/(?:msie |trident\/.*; rv:)(\d+)/);
            ...
            this.OS.isIOS7 = this.OS.isIOS && /(iPad|iPhone|iPod touch);.*CPU.*OS 7_\d/i.test(userAgent);
