angular
    ...
    .service('EntityBuilder', [
        ...
        function(Entity, THREE, $components, $geometryCache, $materialCache, $injector, $log) {
            ...
            this.load = function(json, sceneName, callback) {
                ...
                if (Meteor.isClient) {
                    images = objectLoader.parseImages(json.images, callback);                
                ...
                var entity = this.parseEntity(json.object);
                entity = this.postProcessEntity(entity, geometries, materials);
                entity.__fromClara = true;
                return entity;
            };
                ...
                switch (data.type) {
                    ...
                    case 'Mesh':
                        ...
                        entity.parent.children.forEach(function(child) {
                            if (child.data.type.indexOf('Collider') !== -1) {
                    ...
                    case 'BoxCollider':
                        ...
                        entity.position.add((new THREE.Vector3()).fromArray(data.userData.center));

                        entity.addComponent($components.get('rigidBody', {
                            shape: {
                                type: 'box',
