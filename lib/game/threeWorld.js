        ...
        function(World, THREE, $http, $q, EntityBuilder, $log) {
            ...
            var ThreeWorld = World.extend({
                ...
                load: function(sceneName) {
                    ...
                    if (Meteor.isClient) {
                        world._loadTask = $http.get('scene/' + sceneName + '/ib-world.json')
                    ...
                    return world._loadTask
                        .then(function(json) {
                            ...
                            // Hot-patch time
                            // Insert an ambient light according to these hacks
                            // We must keep these up-to-date with the levels until Clara gives
                            // us a way to export the Ambient light setting in scenes
                            switch(sceneName) {
                                case 'ravenwood-zone':
                                    json.object.children.push({
